...
#define REDIS_SESSION_EQSLOT_UNKNOWN1_str         "itemUnk1"
...
#define REDIS_SESSION_EQSLOT_UNKNOWN3_str         "itemUnk3"
#define REDIS_SESSION_EQSLOT_UNKNOWN4_str         "itemUnk4"
#define REDIS_SESSION_EQSLOT_UNKNOWN5_str         "itemUnk5"
#define REDIS_SESSION_EQSLOT_LEG_ARMOR_str       "leg_armor"
#define REDIS_SESSION_EQSLOT_UNKNOWN6_str         "itemUnk6"
#define REDIS_SESSION_EQSLOT_UNKNOWN7_str         "itemUnk7"
...
enum RedisGameSessionFields {
    ...
    REDIS_GAME_SESSION_EQSLOT_UNKNOWN1,
    ...
    REDIS_GAME_SESSION_EQSLOT_UNKNOWN3,
    REDIS_GAME_SESSION_EQSLOT_UNKNOWN4,
    REDIS_GAME_SESSION_EQSLOT_UNKNOWN5,
    REDIS_GAME_SESSION_EQSLOT_LEG_ARMOR,
    REDIS_GAME_SESSION_EQSLOT_UNKNOWN6,
    REDIS_GAME_SESSION_EQSLOT_UNKNOWN7,
