...
INSERT INTO `commanders` (`commander_id`, `commander_name`, `account_id`, `last_login`, `last_logout`, `time_created`, `is_deleted`, `time_deleted`, `level`, `exp`, `gender`, `job_id`, `class_id`, `hair_id`, `map_id`, `position_x`, `position_y`, `position_z`, `barrack_position_x`, `barrack_position_y`, `barrack_position_z`, `hp`, `mp`, `eqslot_head_top`, `eqslot_head_middle`, `eqslot_unknown_1`, `eqslot_body_armor`, `eqslot_gloves`, `eqslot_boots`, `eqslot_helmet`, `eqslot_bracelet`, `eqslot_weapon`, `eqslot_shield`, `eqslot_costume`, `eqslot_unknown_3`, `eqslot_unknown_4`, `eqslot_unknown_5`, `eqslot_leg_armor`, `eqslot_unknown_6`, `eqslot_unknown_7`, `eqslot_ring_left`, `eqslot_ring_right`, `eqslot_necklace`) VALUES
